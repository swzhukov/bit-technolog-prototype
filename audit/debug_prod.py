...
stdin, stdout, stderr = client.exec_command('systemctl status bit-technolog | head -10; echo "---LOG---"; tail -20 /var/log/bit-technolog.err.log; echo "---LOG/OUT---"; tail -10 /var/log/bit-technolog.log', timeout=30)
